...
<table>
  <tr>
    <td>
    Customizable fantasy football lineup optimizer built with Python and linear programming in PuLP. Optimize DraftKings lineups with adjustable stacking, exclusion, player, and position controls for highest projections under roster and salary constraints. Updated weekly during NFL season for Sunday Classic contests. 
    </td>
  </tr>
</table> 
